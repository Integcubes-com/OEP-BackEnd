                        ...
                        for (var k = 0; k < yearList.Count; k++)
                        {
                            ...
                            for (var l = 0; l < yearlyTotalList.Count; l++)
                            {
                                ...
                                for (var p = 0; p < outagesList.Count; p++)
                                {
                                    ...
                                    if ((outagesList[p].runningHours != null && outagesList[p].runningHours <= outagesList[p].counter && yearlyTotalList[l].monthId == 12) || (outagesList[p].nextOutageDate.Year == yearList[k] && yearlyTotalList[l].monthId == 12 && outagesList[p].validate != "NoValidate"))
                                    {
